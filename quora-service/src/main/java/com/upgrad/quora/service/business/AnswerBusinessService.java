...
public class AnswerBusinessService {
    ...
    @Transactional(propagation = Propagation.REQUIRED)
    public AnswerEntity editAnswerContent(String changedAnswerContent, AnswerEntity answerEntity,UserAuthTokenEntity userAuthTokenEntity) throws AnswerNotFoundException {
        ...
        if (answerEntity.getUser().getId() == userAuthTokenEntity.getUser().getId()) {
            ...
            throw new AnswerNotFoundException("ATHR-003", "Only the answer owner can edit the answer");
        }
